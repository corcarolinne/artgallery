        ...
        <div class="container-form">
            ...
            <div class="form-group" <?php if (isset($empty_field_error)): ?> class="form_error" <?php endif ?>>
                ...
                <div class="form-group">
                    ...
                    <input type="name" class="form-control" placeholder="Type" name="type" value="<?php echo $type; ?>">
                </div>
                <button type="submit" name="update-art" class="btn btn-default">Update Art</button>
            </form>
        </div>
    </div>
